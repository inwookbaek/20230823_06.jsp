	...
	<div class="container mt-sm-5" align="center">	
		<div class="jumbotron">
			...
			<c:if test="${ boardList.isEmpty() }">
				<h4><p class="bg-danger text-white">등록된 게시글이 없습니다!!</p></h4>
			</c:if>
		</div>	
	...
	<div class="container" align="center">
		<ul class="pagination justify-content-center">
			<c:if test="${ pageInfo.getStartPage() != 1 }">
				<li class="page-item page-link"><a href="boardList.bo?p=1"><i class="fas fa-fast-backward"></a></i></li>
				<li class="page-item page-link"><a href="boardList.bo?p=${ pageInfo.getStartPage() - 10 }"><i class="fas fa-backward"></i></a></li>			
			</c:if>
			
			<c:forEach var="page_num" begin="${ pageInfo.getStartPage() }" end="${ pageInfo.getEndPage() }">
				<li class="page-item page-link"><a href="boardList.bo?p=${ page_num }">${ page_num }</a></li>
			</c:forEach>
			
			<c:if test="${ pageInfo.getEndPage() < pageInfo.getTotalPage() }">
				<li class="page-item page-link"><a href="boardList.bo?p=${ pageInfo.getStartPage() + 10 }"><i class="fas fa-forward"></i></a></li>
				<li class="page-item page-link"><a href="boardList.bo?p=${ pageInfo.getTotalPage() }"><i class="fas fa-fast-forward"></i></a></li>			
			</c:if>
